...
/*     */   private String key;
/*     */   private V value;
/*  62 */   private final Map<Character, AbbreviationMap<V>> children = new TreeMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  91 */       child = (AbbreviationMap)child.children.get(Character.valueOf(each));
/*  92 */       if (child == null) {
/*  93 */         return null;
/*     */       }
/*     */     }
/*  96 */     return (V)child.value;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 141 */     AbbreviationMap<V> child = (AbbreviationMap)this.children.get(Character.valueOf(nextChar));
/* 142 */     if (child == null) {
...
/* 178 */     AbbreviationMap<V> child = (AbbreviationMap)this.children.get(Character.valueOf(nextChar));
/* 179 */     if ((child == null) || (!child.remove(aKey, offset + 1, length))) {
/* 180 */       return false;
/*     */     }
/* 182 */     this.keysBeyond -= 1;
...
/* 192 */     Map.Entry<Character, AbbreviationMap<V>> entry = (Map.Entry)this.children.entrySet().iterator().next();
/* 193 */     AbbreviationMap<V> onlyChild = (AbbreviationMap)entry.getValue();
...
/*     */   {
/* 216 */     Map<String, V> mappings = new TreeMap();
...
/* Location:              M:\AFolderOfMinecraft\Minecraft.jar!\joptsimple\internal\AbbreviationMap.class
