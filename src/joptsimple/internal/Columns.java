...
/*     */     
/*  55 */     List<Row> rows = new ArrayList();
...
/*  67 */     List<String> pieces = new ArrayList();
/*     */     
...
/*  76 */     List<String> pieces = new ArrayList();
/*     */     
...
/*  85 */       nextPiece = processNextWord(line, nextPiece, start, end, width, pieces);start = end;
/*     */     }
...
/* Location:              M:\AFolderOfMinecraft\Minecraft.jar!\joptsimple\internal\Columns.class
