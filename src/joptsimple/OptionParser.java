...
/*     */   {
/* 310 */     NonOptionArgumentSpec<String> spec = new NonOptionArgumentSpec();
/*     */     
/* 312 */     recognize(spec);
/*     */     
/* 314 */     return spec;
...
/*     */   {
/* 326 */     NonOptionArgumentSpec<String> spec = new NonOptionArgumentSpec(description);
/*     */     
/* 328 */     recognize(spec);
/*     */     
/* 330 */     return spec;
...
/* 451 */     Collection<String> missingRequiredOptions = new HashSet();
/*     */     
...
/*     */       }
/*     */     }
/* 553 */     Set<OptionSpec<?>> associated = (Set)this.requiredIf.get(precedentSynonyms);
/* 554 */     if (associated == null) {
/* 555 */       associated = new HashSet();
...
/* 602 */     Map<String, List<?>> defaults = new HashMap();
/* 603 */     for (Map.Entry<String, AbstractOptionSpec<?>> each : this.recognizedOptions.toJavaUtilMap().entrySet())
...
/* Location:              M:\AFolderOfMinecraft\Minecraft.jar!\joptsimple\OptionParser.class
