...
/*     */   {
/*  80 */     ArgumentAcceptingOptionSpec<String> newSpec = new RequiredArgumentOptionSpec(options(), description());
/*     */     
...
/*     */   {
/*  93 */     ArgumentAcceptingOptionSpec<String> newSpec = new OptionalArgumentOptionSpec(options(), description());
/*     */     
...
/*     */   {
/* 110 */     List<String> dependents = new ArrayList();
...
/* Location:              M:\AFolderOfMinecraft\Minecraft.jar!\joptsimple\OptionSpecBuilder.class
