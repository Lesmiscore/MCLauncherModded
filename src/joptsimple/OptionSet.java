...
/*     */   {
/* 104 */     AbstractOptionSpec<?> spec = (AbstractOptionSpec)this.detectedOptions.get(option);
...
/*     */     
/* 125 */     List<String> values = (List)this.optionsToArguments.get(option);
...
/*     */     
/* 146 */     AbstractOptionSpec<?> spec = (AbstractOptionSpec)this.detectedOptions.get(option);
/* 147 */     if (spec == null) {
...
/*     */     
/* 194 */     AbstractOptionSpec<?> spec = (AbstractOptionSpec)this.detectedOptions.get(option);
...
/*     */     
/* 215 */     List<String> values = (List)this.optionsToArguments.get(option);
/* 216 */     if ((values == null) || (values.isEmpty())) {
/* 217 */       return defaultValueFor(option);
/*     */     }
/* 219 */     AbstractOptionSpec<V> spec = (AbstractOptionSpec)option;
/* 220 */     List<V> convertedValues = new ArrayList();
...
/*     */   {
/* 244 */     return Collections.unmodifiableList(valuesOf((OptionSpec)this.detectedOptions.get("[arguments]")));
/*     */   }
/*     */   
...
/*     */     }
/* 257 */     List<String> optionArguments = (List)this.optionsToArguments.get(spec);
/*     */     
...
/* 277 */     Map<AbstractOptionSpec<?>, List<String>> thisOptionsToArguments = new HashMap(this.optionsToArguments);
/*     */     
/* 279 */     Map<AbstractOptionSpec<?>, List<String>> otherOptionsToArguments = new HashMap(other.optionsToArguments);
/*     */     
...
/*     */   public int hashCode()
/*     */   {
/* 287 */     Map<AbstractOptionSpec<?>, List<String>> thisOptionsToArguments = new HashMap(this.optionsToArguments);
/*     */     
...
/* 294 */       return (List)this.defaultValues.get(option);
/*     */     }
/* 296 */     return Collections.emptyList();
/*     */   }
/*     */   
/*     */   private <V> List<V> defaultValueFor(OptionSpec<V> option) {
/* 300 */     return defaultValuesFor((String)option.options().iterator().next());
/*     */   }
/*     */ }


/* Location:              M:\AFolderOfMinecraft\Minecraft.jar!\joptsimple\OptionSet.class
