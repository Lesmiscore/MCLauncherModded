...
public class OptionSet {
	...
	public List<?> nonOptionArguments() {
		return Collections
				.unmodifiableList(valuesOf((OptionSpec<?>) this.detectedOptions
						.get("[arguments]")));
	}
	...
	public boolean equals(Object that) {
		...
		Map<AbstractOptionSpec<?>, List<String>> thisOptionsToArguments = new HashMap<AbstractOptionSpec<?>, List<String>>(
				this.optionsToArguments);

		Map<AbstractOptionSpec<?>, List<String>> otherOptionsToArguments = new HashMap<AbstractOptionSpec<?>, List<String>>(
	...
	public int hashCode() {
		...
		return this.detectedOptions.hashCode()
